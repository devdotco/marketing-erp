...
export const SITES: Site[] = [
  ...
  },
  {
    key: "cyberattack-ai",
    name: "CyberAttack.ai",
    homepage: "https://cyberattack.ai",
    tagline: "AI cybersecurity and risk management automation: continuous monitoring, prioritized vulnerabilities, compliance evidence and automated remediation",
    subPages: [
      { url: "https://cyberattack.ai/compliance/hipaa", title: "HIPAA Compliance", description: "HIPAA compliance services for healthcare organizations handling protected health information" },
      { url: "https://cyberattack.ai/compliance/iso-27001", title: "ISO 27001 Certification", description: "Achieving ISO 27001 certification for enterprise information security management" },
      { url: "https://cyberattack.ai/compliance/pci-dss", title: "PCI DSS Compliance", description: "PCI DSS compliance services for businesses that process credit card payments" },
      { url: "https://cyberattack.ai/blog/ai-vs-ai-how-machine-learning-is-both-a-cybersecurity-threat-and-solution", title: "AI vs AI in Cybersecurity", description: "How machine learning is simultaneously being used by attackers and defenders in modern cybersecurity" },
    ],
